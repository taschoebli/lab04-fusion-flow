...
public class retrieveLastBookingItem {
	...
	private final static String BASE_URI = "https://api.regiondo.com/v1";
	private final static String PRODUCT_LIST_URI = BASE_URI + "/supplier/solditemslist?limit=1&date_range_by=date_bought";

	private static final String YOUR_PUBLIC_KEY = "PA171f54c835045";
	private static final String YOUR_SECRET_KEY = "fcf54c829e88f09de35045deb1cb0b679600e";
	...
	public String getProductsJson() {
		ImmutableMap<String, String> queryParams = new ImmutableMap.Builder<String, String>()
				...
				.put("offset", "0")
				.build();
		UriComponents c = UriComponentsBuilder.fromUriString(PRODUCT_LIST_URI).buildAndExpand(queryParams);
